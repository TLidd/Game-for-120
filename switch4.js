...
switch4.prototype = {
   ...
   create: function(){
      ...
      //text for the level
      levelText = game.add.text(game.world.centerX, game.world.centerY, 'LEVEL FOUR', textStyle);
      levelText.anchor.set(0.5, 0.5);
      game.camera.follow(levelText);
      game.time.events.add(Phaser.Timer.SECOND * 5, startLevel4, this);
   },
   update: function(){
